...
def test_create_image_returns_new_image_with_correct_initial_data(mocked_repo_create_image, mocked_repo_get_session):
    ...
    result = create_image(123, file_name)
